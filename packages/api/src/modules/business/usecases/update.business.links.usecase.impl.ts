...
@Injectable()
export class UpdateBusinessLinksUseCaseImpl implements UpdateBusinessLinksUseCase {
  constructor(
  ...
  async execute(
    ...
    const updated = business.updateBusinessLinks({
      businessLinks: command.businessLinks,
