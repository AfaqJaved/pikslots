...
export const FindAllBookingsByBusinessForUserDocs = () =>
  applyDecorators(
    ApiOperation({ summary: 'Get all bookings for a business, optionally scoped to a user' }),
    ApiParam({ name: 'businessId', description: 'Business ID', example: '01932b4a-5f3c-7e1d-b2a8-3c9d4e5f6a7b' }),
    ApiParam({ name: 'userId', description: 'User ID', example: '01932b4a-5f3c-7e1d-b2a8-3c9d4e5f6a7c' }),
    ApiResponse({
          ...
          data: [
            {
              ...
              serviceSnapshot: { title: 'Haircut', durationInMins: 30, cost: 2500 },
