...
export const SERVICE_TEST_DATA: Service[] = [
  ...
  Service.create({
    ...
    imagesUrls: [
      ...
      'https://cdn.example.com/services/haircut-2.jpg',
    ],
    durationInMins: 45,
    bufferTimeInMins: 15,
    cost: 40,
  ...
  Service.create({
    ...
    imagesUrls: [
      'https://cdn.example.com/services/massage-1.jpg',
      'https://cdn.example.com/services/massage-2.jpg',
      'https://cdn.example.com/services/massage-3.jpg',
      'https://cdn.example.com/services/massage-4.jpg',
      'https://cdn.example.com/services/massage-5.jpg',
    ],
    durationInMins: 60,
    bufferTimeInMins: 20,
    cost: 90,
  ...
  Service.create({
    ...
    imagesUrls: ['https://cdn.example.com/services/manicure-1.jpg'],
    durationInMins: 30,
    bufferTimeInMins: 10,
    cost: 25,
    isHiddenFromBookingPage: false,
  ...
  Service.reconstitute({
    ...
    images: ['https://cdn.example.com/services/facial-1.jpg'],
    durationInMins: 50,
    bufferTimeInMins: 15,
    cost: 60,
    isHiddenFromBookingPage: true,
