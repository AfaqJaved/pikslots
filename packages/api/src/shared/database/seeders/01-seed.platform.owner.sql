...
SELECT
  ...
  '{"brandColor":"#000000","brandButtonShape":"rounded","theme":"system","gallaryPhotosUrls":[]}'::jsonb,
  ...
  '{"notifyBookingConfirmation":true,"notifyBookingChanges":true,"notifyBookingCancellations":true,"bookingRemindersTime":{"unit":"hours","value":24},"extraCCEmails":[]}'::jsonb,
  '{"notifyBookingConfirmation":true,"notifyBookingChanges":true,"notifyBookingCancellations":true,"bookingRemindersTime":{"unit":"hours","value":24}}'::jsonb,
