				...
				<div class="flex-1 overflow-y-auto px-6 py-5">
					<FieldGroup>
						...
						<div class="grid grid-cols-2 gap-4">
							<Field>
								...
								<Input data-testid="edit-customer-first-name" bind:value={$form.firstName} placeholder="Enter first name" />
								<FieldError data-testid="edit-customer-first-name-error" errors={$errors.firstName?.map((e) => ({ message: e }))} />
							</Field>
							<Field>
								<FieldLabel>Last name</FieldLabel>
								<Input data-testid="edit-customer-last-name" bind:value={$form.lastName} placeholder="Enter last name" />
								<FieldError data-testid="edit-customer-last-name-error" errors={$errors.lastName?.map((e) => ({ message: e }))} />
							</Field>
						</div>
						...
						<Field>
							...
							<InputGroup.Root>
								...
								<InputGroup.Input data-testid="edit-customer-phone" bind:value={$form.phone} placeholder="Enter phone number" />
							</InputGroup.Root>
							<FieldError data-testid="edit-customer-phone-error" errors={$errors.phone?.map((e) => ({ message: e }))} />
						</Field>

						<!-- Primary email -->
						<Field>
							<FieldLabel>Primary email</FieldLabel>
							<Input data-testid="edit-customer-email" bind:value={$form.email} type="email" placeholder="Enter email address" />
							<FieldError data-testid="edit-customer-email-error" errors={$errors.email?.map((e) => ({ message: e }))} />
						</Field>

						<!-- Company -->
						<Field>
							<FieldLabel>Company</FieldLabel>
							<Input data-testid="edit-customer-company" bind:value={$form.company} placeholder="Enter company name" />
							<FieldError data-testid="edit-customer-company-error" errors={$errors.company?.map((e) => ({ message: e }))} />
						</Field>
					</FieldGroup>
					...
					<FieldGroup>
						...
						<Field>
							...
							<FieldError data-testid="edit-customer-country-error" errors={$errors.country?.map((e) => ({ message: e }))} />
						</Field>
						...
						<Field>
							...
							/>
							<FieldError data-testid="edit-customer-address-error" errors={$errors.address?.map((e) => ({ message: e }))} />
						</Field>

						<!-- City -->
						<Field>
							<FieldLabel>City</FieldLabel>
							<Input data-testid="edit-customer-city" bind:value={$form.city} placeholder="Enter city" />
							<FieldError data-testid="edit-customer-city-error" errors={$errors.city?.map((e) => ({ message: e }))} />
						</Field>
						...
						<div class="grid grid-cols-2 gap-4">
							<Field>
								...
								<Input data-testid="edit-customer-state" bind:value={$form.state} placeholder="Select state" />
								<FieldError data-testid="edit-customer-state-error" errors={$errors.state?.map((e) => ({ message: e }))} />
							</Field>
							<Field>
								<FieldLabel>Zip code</FieldLabel>
								<Input data-testid="edit-customer-zip" bind:value={$form.zipCode} placeholder="Enter code" />
								<FieldError data-testid="edit-customer-zip-code-error" errors={$errors.zipCode?.map((e) => ({ message: e }))} />
							</Field>
						</div>
					</FieldGroup>
						...
						<FieldGroup>
							{#if extraFields.has('phone')}
								<Field>
									...
									<Input data-testid="edit-customer-additional-phone" bind:value={$form.additionalPhone} placeholder="Enter phone number" />
									<FieldError data-testid="edit-customer-additional-phone-error" errors={$errors.additionalPhone?.map((e) => ({ message: e }))} />
								</Field>
							{/if}
							{#if extraFields.has('email')}
								<Field>
									...
									/>
									<FieldError data-testid="edit-customer-additional-email-error" errors={$errors.additionalEmail?.map((e) => ({ message: e }))} />
								</Field>
							{/if}
							{#if extraFields.has('website')}
								<Field>
									<FieldLabel>Website</FieldLabel>
									<Input data-testid="edit-customer-website" bind:value={$form.website} placeholder="https://example.com" />
								</Field>
							{/if}
							{#if extraFields.has('instagram')}
								<Field>
									<FieldLabel>Instagram</FieldLabel>
									<Input data-testid="edit-customer-instagram" bind:value={$form.instagram} placeholder="@username" />
								</Field>
							{/if}
							{#if extraFields.has('facebook')}
								<Field>
									<FieldLabel>Facebook</FieldLabel>
									<Input data-testid="edit-customer-facebook" bind:value={$form.facebook} placeholder="Profile URL or username" />
								</Field>
							{/if}
							{#if extraFields.has('x')}
								<Field>
									<FieldLabel>X</FieldLabel>
									<Input data-testid="edit-customer-x" bind:value={$form.x} placeholder="@username" />
								</Field>
							{/if}
							{#if extraFields.has('youtube')}
								<Field>
									<FieldLabel>YouTube</FieldLabel>
									<Input data-testid="edit-customer-youtube" bind:value={$form.youtube} placeholder="Channel URL" />
								</Field>
							{/if}
							{#if extraFields.has('linkedin')}
								<Field>
									<FieldLabel>LinkedIn</FieldLabel>
									<Input data-testid="edit-customer-linkedin" bind:value={$form.linkedin} placeholder="Profile URL or username" />
								</Field>
							{/if}
						</FieldGroup>
					{/if}
